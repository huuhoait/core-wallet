...
func New(ctx context.Context, dsn, dbName, dbHost string, logger *zerolog.Logger) (*PgOutboxRepo, error) {
	...
	logger.Info().Str("db", dbName).Str("host", dbHost).Msg("Outbox repository ready")
